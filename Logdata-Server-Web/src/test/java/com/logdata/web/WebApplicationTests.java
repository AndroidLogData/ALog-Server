...
//		LogVO log = new LogVO("1", "android", "i", "[MainActivity::onCreate]", "Hello, World!", currentTime, null ,"apiKey");
//
...
//
//		CrashVO crashVO = new CrashVO("1", "android", currentTime, "5.0", "1", "1.0", 1L, "samsung", "logcat", "deviceID", display, environment, deviceFeature, build, "apiKey");
//
