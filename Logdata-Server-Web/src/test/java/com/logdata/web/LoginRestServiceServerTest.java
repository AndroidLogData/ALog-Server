...
//    @Test
//    public void userRegistrationPageSameIDTest() throws Exception {
//        this.server.expect(
...
//    @Test
//    public void userRegistrationPagePOSTTest() throws Exception {
//        this.server.expect(
//                ExpectedCount.manyTimes(),
//                requestTo(API_BASE_URL + "/user/find/query?name=user"))
//                .andExpect(method(HttpMethod.GET))
...
//        this.server.expect(
//                ExpectedCount.manyTimes(),
//                requestTo(API_BASE_URL + "/user/registration"))
