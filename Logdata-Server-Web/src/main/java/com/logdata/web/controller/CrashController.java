...
import com.logdata.web.util.Utility;
...
public class CrashController {
    ...
    public String crashDataTimeView(Principal user, @RequestParam(value = "time") String time, @RequestParam(value = "packageName") String packageName, Model model) {
        ...
        CrashVO crashVO = this.crashDataService.findCrashDataByTimeAndApiKeyAndPackageName(dt, getUserApiKey(user), packageName);
    ...
    public String crashPackageNamePage(Principal user, Model model, @RequestParam(value = "packageName") String packageName) {
        ...
        CrashVO crashVO = this.crashDataService.findCrashDataByPackageNameAndApiKeyOrderByTimeDesc(packageName, getUserApiKey(user));
    ...
    private Set<String> getPackageName(Principal user) {
        List<CrashVO> setData = this.crashDataService.findByApiKey(getUserApiKey(user));
    ...
    public ArrayList<CrashTimeVO> getCrashTime(Principal user, String packageName) {
        ArrayList<CrashVO> list = this.crashDataService.findByApiKeyAndPackageNameOrderByTimeAsc(getUserApiKey(user), packageName);
