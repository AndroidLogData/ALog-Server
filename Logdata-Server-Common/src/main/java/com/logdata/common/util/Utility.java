...
public class Utility {
    public String getStringTimeToDateTime(DateTime time) {
    ...
    public String getStringTimeToLong(long time) {
        DateTime date = new DateTime(time);
        DateTimeFormatter fmt = DateTimeFormat.forPattern("yyyy-MM-dd HH:mm:ss.SSS");
    ...
    public String findCrashName(String logcat) {
    ...
    public String logcatSummary(String logcat) {
